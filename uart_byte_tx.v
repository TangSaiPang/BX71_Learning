...
//    reg [4:0]bit_cnt;
//    reg [25:0]cnt0;
//    reg [12:0]baud_div_cnt; // time when we transmit data
////    reg uart_idle;
//    reg uart_en;
    
//    parameter DATA_CNT_MAX = 7;
//    parameter TIME_UNIT_1S = 50_000_000 - 1;
//    parameter TIME_UNIT_BAUDRATE = 5208 - 1;
//    parameter SART_BIT = 1'b0;
//    parameter STOP_BIT = 1'b1;
    
//    // counter that we use to run 1 second
//    always@(posedge clk or negedge rst_n)
//    if(!rst_n)
//        cnt0 <= 0;
//    else if(cnt0 == TIME_UNIT_1S)
//        cnt0 <= 0;
//    else
//        cnt0 <= cnt0 + 1'd1;
    
//    // counter that we use to run 1/9600 seconds
//    always@(posedge clk or negedge rst_n)
//    if(!rst_n)
//        baud_div_cnt <= 0;
//    else if(uart_en)begin
//        if(baud_div_cnt == TIME_UNIT_BAUDRATE)
//            baud_div_cnt <= 0;
//        else
...
//    if(!rst_n)
//        uart_en <= 1'b0;
//    else if(cnt0 == TIME_UNIT_1S)// && (uart_state == transmit_done)
//        uart_en <= 1'b1;
//    else
//        uart_en <= 1'b0;
...
//    if(!rst_n)
//        bit_cnt <= 0;
//    else if(baud_div_cnt == TIME_UNIT_BAUDRATE)begin
//        if(bit_cnt == 10 - 1)
//            bit_cnt <= 0;
//        else
...
//    if(!rst_n)
//        led <= 1'b0;
//    else if((bit_cnt == 9) && (baud_div_cnt == TIME_UNIT_BAUDRATE))
//        led <= !led;
